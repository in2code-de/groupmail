...
class HideUnHideRecordViewHelper extends AbstractTagBasedViewHelper
{
    /**
     * @var string
     */
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('currentStatus', 'bool', 'the current status of the record', true);
            ...
            [
                'data' => [
                    $this->arguments['table'] => [
                        $this->arguments['uid'] => [
                            'hidden' => !$this->arguments['currentStatus']
                        ]
                    ]
                ],
